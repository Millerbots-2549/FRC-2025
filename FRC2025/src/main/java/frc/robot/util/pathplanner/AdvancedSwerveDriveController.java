...
// Most stuff from Ninjineers swerve code

/** Add your docs here. */
public class AdvancedSwerveDriveController implements PathFollowingController {
     ...
     */
    public AdvancedSwerveDriveController(
    ...
    public static void setRotationTargetOverride(
        ...
        AdvancedSwerveDriveController.rotationTargetOverride = rotationTargetOverride;
    }
    ...
    public static void overrideXFeedback(DoubleSupplier xFeedbackOverride) {
        AdvancedSwerveDriveController.xFeedbackOverride = xFeedbackOverride;
    }
    ...
    public static void clearXFeedbackOverride() {
        AdvancedSwerveDriveController.xFeedbackOverride = null;
    }
    ...
    public static void overrideYFeedback(DoubleSupplier yFeedbackOverride) {
        AdvancedSwerveDriveController.yFeedbackOverride = yFeedbackOverride;
    }
    ...
    public static void clearYFeedbackOverride() {
        AdvancedSwerveDriveController.yFeedbackOverride = null;
    }
    ...
    public static void overrideRotationFeedback(DoubleSupplier rotationFeedbackOverride) {
        AdvancedSwerveDriveController.rotFeedbackOverride = rotationFeedbackOverride;
    }
    ...
    public static void clearRotationFeedbackOverride() {
        AdvancedSwerveDriveController.rotFeedbackOverride = null;
    }
    ...
    public static void setXSetpointIncrement(DoubleSupplier xSetpointIncrement) {
        AdvancedSwerveDriveController.xSetpointIncrement = xSetpointIncrement;
    }

    public static void setYSetpointIncrement(DoubleSupplier ySetpointIncrement) {
        AdvancedSwerveDriveController.ySetpointIncrement = ySetpointIncrement;
    }

    public static void setRotSetpointIncrement(DoubleSupplier rotSetpointIncrement) {
        AdvancedSwerveDriveController.rotSetpointIncrement = rotSetpointIncrement;
    }
}
